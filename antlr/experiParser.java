...
public class experiParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "experi.g4"; }
	...
	public experiParser(TokenStream input) {
		super(input);
	...
	public static class StartContext extends ParserRuleContext {
		...
		public List<TerminalNode> NEWLINE() { return getTokens(experiParser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(experiParser.NEWLINE, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof experiListener ) ((experiListener)listener).enterStart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof experiListener ) ((experiListener)listener).exitStart(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(experiParser.INT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof experiListener ) ((experiListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof experiListener ) ((experiListener)listener).exitExpr(this);
		}
	}
